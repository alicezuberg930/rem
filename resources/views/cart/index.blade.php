...
<body>
    ...
    <div class="container-md shadow mt-4 mb-4">
        <div class="pt-4 border-top">
                                        ...
                                        <td>
                                            <div class="d-flex">
                                                ...
                                                <input id="inp{{ $cart['id'] }}" type="number" min="1"
                                                    max="99" class="bg-white border-0 text-center" step="1"
                                                    disabled value="{{ $cart['quantity'] }}" size="1">
            ...
            @if (session()->has('cart') && count(session('cart')) > 0)
                <div class="col-md-4">
                    <form class="p-3 mb-3 border text-dark">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control fw-semibold bg-white"
                                    id="pay-sum">{{ number_format($total_price) }}</span>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control fw-semibold bg-white"
                                    id="pay-sum">{{ number_format($total_discount) }}</span>
                            </div>
                        </div>
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-8">
                                <span class="form-control fw-semibold bg-white"
                                    id="pay-sum">{{ number_format($total_final) }}</span>
                            </div>
                        </div>
