{{-- <div id="carouselExampleControls" class="carousel slide mt-5" data-bs-ride="carousel">
    <div class="carousel-inner">
        <div class="carousel-item active">
            <img src="{{ url('/image/banners/zippo_banner_1.jpg') }}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ url('/image/banners/zippo_banner_2.jpg') }}" class="d-block w-100" alt="...">
        </div>
        <div class="carousel-item">
            <img src="{{ url('/image/banners/zippo_banner_3.jpg') }}" class="d-block w-100" alt="...">
        </div>
    </div>
