<footer class="bg-gray-800">
    <div class="max-w-screen-xl px-4 pt-8 pb-6 mx-auto sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 gap-6 lg:grid-cols-3">
                ...
                <ul class="flex justify-center gap-6 mt-8 md:gap-8 sm:justify-start">
                    <li>
                        <a href="/" rel="noopener noreferrer" target="_blank">
                            ...
                            <x-bi-facebook class="w-6 h-6 hover:text-blue-500" fill="#8fc2f8" />
                        </a>
                    </li>
                    ...
                    <li>
                        <a href="/" rel="noopener noreferrer" target="_blank">
                            ...
                            <svg class="w-6 h-6 text-blue-300 transition hover:text-blue-500" fill="currentColor"
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:col-span-2 md:grid-cols-4">
                <div class="">
                    ...
                    <nav class="mt-8">
                        <ul class="space-y-4 text-sm">
                            <li>
                                <a href="/">
                                    <span class="text-white">Company History</span>
                                </a>
                            </li>
                            ...
                            <li>
                                <a href="/">
                                    <span class="text-white">Employee Handbook</span>
                                </a>
                            </li>
            ...
            <div class="flex justify-between items-center">
                ...
                <span class="text-sm text-gray-400">
                    ...
                    <a class="inline-block" href="/">
                        <span class="text-blue-300 transition hover:text-blue-300/75">Terms & Conditions</span>
                    </a>
                    <span>&middot;</span>
                    <a class="inline-block" href="/">
                        <span class="text-blue-300 transition hover:text-blue-300/75">Privacy Policy</span>
                    </a>
                </span>
            </div>
        </div>
