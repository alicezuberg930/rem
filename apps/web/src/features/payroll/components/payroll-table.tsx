...
import type { QueryPayroll } from '@/@types'
...
const route = getRouteApi('/_authenticated/payroll/')
...
export function PayrollTable() {
  ...
  const queryParams = useMemo<QueryPayroll>(
    () => ({ page: pagination.pageIndex, pageSize: pagination.pageSize }),
    [pagination.pageIndex, pagination.pageSize]
  )

  const { data, isLoading } = useQuery(payroll().all.queryOptions(queryParams))
