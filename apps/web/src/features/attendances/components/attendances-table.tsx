...
import { attendancesColumns as columns } from './attendances-columns'
import { attendance } from '@/lib/queries/attendance'

const route = getRouteApi('/_authenticated/attendances/')
...
export function AttendancesTable() {
  ...
  const {
    ...
    columnFilters: [
      ...
      { columnId: 'address', searchKey: 'address', type: 'string' },
      { columnId: 'checkInTime', searchKey: 'checkInTime', type: 'string' },
    ],
  })
  ...
  return (
    ...
    >
      <DataTableToolbar
        table={table}
        searchPlaceholder='Filter attendances...'
        searchKey='name'
        filters={[
          {
            columnId: 'address',
