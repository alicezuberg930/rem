      ...
      queryOptions({
        ...
        queryFn: async () => {
          const { data } = await httpClient.get<
            PaginatedApiResponse<Template[]>
          >('/templates', opts as Record<string, unknown>)
          return data
        },
      }),
  },
  ...
  one: {
    ...
    queryOptions: (id: string) =>
      queryOptions({
        ...
        queryFn: async () => {
          const { data } = await httpClient.get<ApiResponse<Template[]>>(
            `/templates/${id}`
          )
          return data
        },
    ...
    mutationOptions: () =>
      mutationOptions({
        ...
        mutationFn: async (input: TemplateValidators.TemplateForm) => {
          return await httpClient.post<ApiResponse<Template[]>>(
            '/templates',
            input
          )
        },
