        ...
        >
          ...
          <PopoverTrigger>
            <Button
              ...
              className={cn(
                'flex h-auto min-h-9 items-center justify-between rounded-md border border-input bg-inherit p-1 hover:bg-inherit [&_svg]:pointer-events-auto',
                        ...
                        return (
                          ...
                          >
                            ...
                            >
                              <XCircle
                                className={cn(
                                  'stroke-main-500 size-4',
                                  responsiveSettings.compactMode &&
                                    'stroke-main-500 size-3'
                                )}
                              />
                            </Button>
                          </Badge>
                    ...
                    {selectedValues.length > responsiveSettings.maxCount && (
                      <Badge
                        className={cn(
                          ...
                          getBadgeAnimationClass(),
                          multiSelectVariants({ variant }),
                          responsiveSettings.compactMode && 'px-0 py-0 text-xs',
                          singleLine && 'shrink-0 whitespace-nowrap',
                          '[&>svg]:pointer-events-auto'
                        )}
                        style={{
